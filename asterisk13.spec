...
%attr(0700,asterisk,asterisk) %dir %{logdir}/asterisk
%attr(0700,asterisk,asterisk) %dir %{logdir}/asterisk/cdr-csv
%attr(0700,asterisk,asterisk) %dir %{logdir}/asterisk/cdr-custom
